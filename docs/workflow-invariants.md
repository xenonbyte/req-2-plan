...
| Agent Command Adapter | Compact project shortcut carrier with `r2p-start`, `r2p-continue`, `r2p-tier-lock`, `r2p-status`, `r2p-switch`, and `r2p-reopen`. | `workflow-agent-command-adapter.md` | `Purpose` |
