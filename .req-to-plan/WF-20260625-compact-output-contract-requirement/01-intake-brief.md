...
work_id: WF-20260625-compact-output-contract-requirement
requirement: # Compact Output Contract Requirement
...
## Evidence Block
keywords_hit: ['rewriting', 'rust', 'python', 'sqlite', 'truncate', 'token', 'live', 'token', 'full']
repo_baseline_summary: loc=19891, modules=3, monorepo=False, languages=['Python', 'JavaScript']
linked_context: none
scope_signals: ['full']
