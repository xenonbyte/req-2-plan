...
work_id: WF-20260626-r2p-execute-subagent-authoritative-c
requirement: # r2p-execute Subagent Authoritative-Context Requirement
...
## Evidence Block
keywords_hit: ['python', 'project', 'repo', 'repository', 'cross-project', 'token', 'live', 'role', 'token', 'order', 'depend on', 'all of', 'whole', 'full']
repo_baseline_summary: loc=21962, modules=3, monorepo=False, languages=['Python', 'JavaScript']
linked_context: none
scope_signals: ['all of', 'whole', 'full']
escalation_candidates: ['cross_project', 'safety', 'dependency']
