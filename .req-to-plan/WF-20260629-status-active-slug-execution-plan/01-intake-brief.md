...
work_id: WF-20260629-status-active-slug-execution-plan
requirement: ---
status: active
...
## Evidence Block
keywords_hit: ['project', 'repository', 'token', 'role', 'token', 'order', 'whole', 'full']
repo_baseline_summary: loc=22232, modules=3, monorepo=False, languages=['Python', 'JavaScript']
linked_context: none
