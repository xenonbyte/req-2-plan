...
work_id: WF-20260626-r2p-execute-controller-context-manag
requirement: # r2p-execute Controller Context-Management Requirement
...
## Evidence Block
keywords_hit: ['migration', 'port to', 'go', 'python', 'r', 'repository', 'token', 'live', 'token', 'whole', 'full', 'everything']
repo_baseline_summary: loc=21305, modules=3, monorepo=False, languages=['Python', 'JavaScript']
linked_context: none
scope_signals: ['whole', 'full', 'everything']
