...
work_id: WF-20260711-status-active-slug-code-audit
requirement: ---
status: active
...
## Tier Estimate
base: standard
modifiers: cross_project, safety, scope_expanding

## Evidence Block
keywords_hit: ['python', 'r', 'edge', 'repository', 'delete', 'drop', 'token', 'production', 'live', 'auth', 'token', 'order', 'whole', 'full']
repo_baseline_summary: loc=26287, modules=3, monorepo=False, languages=['Python', 'JavaScript']
linked_context: none
scope_signals: ['whole', 'full']
escalation_candidates: ['cross_project', 'safety']
