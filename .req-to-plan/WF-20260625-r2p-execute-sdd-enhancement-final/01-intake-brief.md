...
work_id: WF-20260625-r2p-execute-sdd-enhancement-final
requirement: # r2p-execute SDD Enhancement & Final-Review Marker Gate Requirement
...
## Evidence Block
keywords_hit: ['migration', 'go', 'python', 'c', 'project', 'drop', 'token', 'role', 'token', 'whole', 'full']
repo_baseline_summary: loc=20364, modules=3, monorepo=False, languages=['Python', 'JavaScript']
linked_context: - execution/final-review.md: local_missing
  error: File not found: /Users/xubo/x-skills/req-to-plan/execution/final-review.md
